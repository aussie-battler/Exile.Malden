...
orderIDcharacters = "GS"; //Characters to be displayed at the start of each unique order number (can be a community name abbreviation ie: ESG (Evolved Survival Gaming).
